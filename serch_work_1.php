...
HTML;
      ...
      echo '<th style="text-align: center;" bgcolor="#EEEEFF">質問またはまとめ2</td></tr>';
...
echo<<<HTML
      ...
      <tr>
HTML;
      echo '<th bgcolor="#EEEEFF" style="text-align: center;">質問またはまとめ2</td></tr>';
...
HTML;
      break;
		...
		echo '<th width="370px" style="text-align: center;"><b>質問とその回答</b></th>';
		...
		switch ($num){
			...
			echo '<th width="370px">' . $row2->question3 .'</b></th>';
			echo '<th width="370px">' . $row2->question4 .'</th>';
			echo '</tr>';
			echo '</thead>';
			echo "</table>";
			break;
		...
		case "6":
			...
			echo '<tr bgcolor="#CCCCFF">';
			//echo '<td width = "6%">' . $row2->school_date .'</td>';
			echo '<td width="370px">' . $row2->question3 .'</td>';
			echo '<td width="370px">' . $row2->question4 .'</td>';
			echo '</tr>';
			echo '</thead>';
			echo "</table>";
	    break;
		...
		echo '<tr>';
                ...
                //echo '<td width = "6%">' . $row2->school_date .'</td>';
echo '<tr bgcolor="#CCCCFF">';
                echo '<td width="370px"><b>' . $row2->question3 .'</b></td>';
                echo '<td width="370px" style="text-align: center;"><b>' . $row2->question4 .'</b></td>';
                echo '</tr>';
					echo '</thead>';
		echo "</table>";
                break;
	...
	if($color3=='0'|| $color3==NULL){
	  ...
	  $color3=dechex($color3);
			...
			case "4":
				...
				?>
				<td width="370px" bgcolor="<?php print $color2;?>" ><?php print nl2br($row3->reply);?></td>
				<?php
				echo '</tr>';
				echo '</tbody>';
				echo "</table>";
...
*/
        ...
        if($row3->comment!='-'){
				...
				//echo '<td width="6%" >' . $row3->school_date .'</td>';
        echo '<td width="370px" style="word-break: break-all;" class="autlink">' . nl2br($row3->comment) .'</td>';
        ?>
        <td width="370px" style="word-break: break-all;" class="autlink" bgcolor="<?php print $color2;?>"> <?php print nl2br($row3->reply);?></td>
        <?php
				echo '</tr>';
				echo '</tbody>';
				echo "</table>";
