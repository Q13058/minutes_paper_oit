...
HTML;
      ...
      echo '<tr><th bgcolor="#EEEEFF" style="text-align: center;">質問またはまとめ3</td></tr>';
      echo '<tr>';
...
HTML;
      break;
		...
		echo '<tr>';
                ...
                //echo '<td width = "6%">' . $row2->school_date .'</td>';
echo '<tr bgcolor="#CCCCFF">';
                echo '<td width="370px"><b>' . $row2->question5 .'</b></td>';
                echo '<td width="370px" style="text-align: center;"><b>' . $row2->question6 .'</b></td>';
                echo '</tr>';
					echo '</thead>';
		echo "</table>";
                break;
...
*/
      	...
      	if($row3->column1!='-'){
				...
				//echo '<td width="6%" >' . $row3->school_date .'</td>';
        echo '<td width="10%">' . nl2br($row3->question) .'</td>';
				?>

        <td width="10%" bgcolor="<?php print $color;?>"> <?php print nl2br($row3->answer);?></td>

				<?php

        echo '<td width="10%">' . nl2br($row3->comment) .'</td>';

				?>

        <td width="10%" bgcolor="<?php print $color2;?>"> <?php print nl2br($row3->reply);?></td>

				<?php
        echo '<td width="10%">' . nl2br($row3->column1) .'</td>';
				echo '<td width="10%">' . nl2br($row3->column2) .'</td>';
				echo '</tr>';
				echo '</tbody>';
				echo "</table>";
			break;
...
*/
        ...
        if($row3->column1!='-'){
				...
				//echo '<td width="6%" >' . $row3->school_date .'</td>';
        echo '<td width="370px" style="word-break: break-all;" class="autlink">' . nl2br($row3->column1) .'</td>';
        ?>
        <td width="370px" style="word-break: break-all;" class="autlink" bgcolor="<?php print $color3;?>"> <?php print nl2br($row3->column2);?></td>
        <?php
				echo '</tr>';
				echo '</tbody>';
				echo "</table>";
