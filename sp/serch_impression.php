...
echo<<<HTML
					...
					<tr>
						...
						<th width = "50%" height="60px" style = "background-color:#ffBB77;"><button class="list" type="button" onclick="#">感想など</button></th>
					</tr>
					</tbody>
					</table>
					<br><br>
...
echo<<<HTML
					...
					<tr>
						...
						<th width = "33%" height="60px" style = "background-color:#ffBB77;"><button class="list" type="button" onclick="#"><font size="3vw">感想など</font></button></th>
					</tr>
					</tbody>
					</table>
					<br><br><br><br>
...
echo<<<HTML
					...
					<tr>
						...
						<th width = "25%" height="60px" style = "background-color:#ffBB77;"><button class="list" type="button" onclick="#"><font size="3vw">感想など</font></button></th>
					</tr>
					</tbody>
					</table>
					<br><br>
